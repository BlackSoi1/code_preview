...
# Define paths
operation_identify_folder='DS-CodeBridge/ds300_prompt_rag/operation_identify'
intermediate_output_folder='DS-CodeBridge/ds300_inter_rag'
rag_prompt_base='DS-CodeBridge/ds300_prompt_rag/rag_prompts'
final_output_folder='DS-CodeBridge/ds300_output_rag'
rag_translation_base="DS-CodeBridge/ds300_prompt_rag/rag_translation"
...
for model_path in "${deployments[@]}"; do
    ...
    for operation_file in "${operation_files[@]}"; do
        ...
        python3 DS-CodeBridge/src/vllm_infer_identify.py \
